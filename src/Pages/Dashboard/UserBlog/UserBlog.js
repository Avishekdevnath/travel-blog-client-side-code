import { Alert, Avatar, Box, Button, Container, Grid, Snackbar, TextField, Typography } from '@mui/material';
...
const UserBlog = () => {
    ...
    const initialInfo = { authorName: user.displayName, authorEmail: user.email, status: 'pending', category: category }
